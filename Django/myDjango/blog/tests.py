...
class TestView(TestCase):
    ...
    def test_post_detail(self):
        ...
        self.assertIn(self.category_me.name, post_area.text)
    ...
    def test_category_page(self):
        response = self.client.get(self.category_me.get_absolute_url())
        self.assertEqual(response.status_code, 200)
        ...
        self.assertIn(self.category_me.name, soup.h3.text)
        
        main_area = soup.find('div', id='main-area')
        self.assertIn(self.category_me.name, main_area.text)
    ...
    def test_create_post(self):
        ...
        self.client.login(username='a', password='aa11aa22')
        response = self.client.get('/blog/create_post/')
        self.assertNotEqual(response.status_code, 200)
        
        self.client.login(username='b', password='bb11bb22')
        response = self.client.get('/blog/create_post/')
        self.assertEqual(response.status_code, 200)
        ...
        self.assertEqual(last_post.author.username, "b")
    ...
    def test_update_post(self):
        ...
        self.assertNotEqual(self.post_003.author, self.user_a)
        self.client.login(
